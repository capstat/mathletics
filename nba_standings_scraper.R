...
#get total point and total points against
team_stats_df$Total.PF = round(
  team_stats_df$`PS/G`*(team_stats_df$W+team_stats_df$L), 0)
team_stats_df$Total.PA = round(
  team_stats_df$`PA/G`*(team_stats_df$W+team_stats_df$L), 0)
#points ratio
team_stats_df$Ratio = team_stats_df$Total.PF/team_stats_df$Total.PA
